const obj6 = {propertyVill : [
    {
        image: './photo/villa-3.jpg',
...
function displayData(allProduct){
    ...
    document.getElementById('productVilla').innerHTML = str

}


displayData(obj6.propertyVill)